...
import { usecreatePostMutations } from "../../mutations/postMutations";
...
function AddPostModal({isOpen, onRequestClose, layoutRef, setHomeRefresh}) {
    ...
    const createPostMutation = usecreatePostMutations();
    ...
    const handleIamgeDeleteOnClick = (index) => {
                    ...
                    <div css={s.imageListBox} ref={imageListBoxRef} onWheel={handleOnWheel}>
                        {
                            uploadImages.map((img, index) => (
                                <div css={s.preview(img.dataURL)}>
                                    <div onClick={() => handleIamgeDeleteOnClick(index)}><IoIosClose /></div>
                                </div>
                            ))
                        }
